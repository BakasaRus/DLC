...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utilities_auth__ = __webpack_require__(51);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		...
		window.axios.get('/api/quotes', { headers: this.$root.auth.headers() }).then(function (response) {
			return _this.quotes = response.data;
		}).catch(function (error) {
			return _this.quotes = [{ body: error.message }];
		});
	}
});
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.quotes, function(quote) {
      return _c("li", [_vm._v(_vm._s(quote.body))])
    })
  )
}
var staticRenderFns = []
...
var Auth = function () {
	...
	_createClass(Auth, [{
		...
		value: function login() {
			...
			window.axios.post('/oauth/token', this.postData).then(function (response) {
