...
/* harmony default export */ __webpack_exports__["default"] = ({
	data: function data() {
		return {
			...
			headers: [{ text: 'ID', value: 'id', align: 'left' }, { text: 'Предмет', value: 'name', align: 'left' }, { text: 'Дата создания', value: 'created_at', align: 'left' }]
		};
	},
	...
	methods: {
		createSubject: function createSubject() {
			...
			window.axios.post('/api/subjects', { name: this.subjectName }, { headers: this.$root.auth.headers() }).then(function (response) {
				...
				_this2.subjectName = '';
				_this2.addingDialog = false;
				window.axios.get('/api/subjects', { headers: _this2.$root.auth.headers() }).then(function (response) {
					return _this2.subjects = response.data;
				}).catch(function (error) {
					return _this2.subjects = [{ name: error.message }];
				});
			}).catch(function (error) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	data: function data() {
		return {
			...
			headers: [{ text: 'ID', value: 'id', align: 'left' }, { text: 'Предмет', value: 'name', align: 'left' }, { text: 'Автор', value: 'author_id', align: 'left' }, { text: 'Предмет', value: 'subject_id', align: 'left' }, { text: 'Дата создания', value: 'created_at', align: 'left' }]
		};
	},
	...
	created: function created() {
		...
		window.axios.get('/api/tests', { headers: this.$root.auth.headers() }).then(function (response) {
			return _this.tests = response.data;
		}).catch(function (error) {
			return _this.tests = [{ name: error.message }];
		});
	},
	...
	methods: {
		createSubject: function createSubject() {
			...
			window.axios.post('/api/tests', { name: this.subjectName }, { headers: this.$root.auth.headers() }).then(function (response) {
				console.log(response.data);
				_this2.subjectName = '';
				_this2.addingDialog = false;
			}).catch(function (error) {
	...
	computed: {
		subjectIDs: function subjectIDs() {
			return this.subjects.map(function (item) {
				return item.id;
			});
		},
		subjectNames: function subjectNames() {
			return this.subjects.map(function (item) {
				return item.name;
			});
		}
  ...
  return _c(
    ...
    [
      _c("v-data-table", {
        ...
        attrs: { headers: _vm.headers, items: _vm.tests, "hide-actions": "" },
        scopedSlots: _vm._u([
          {
            key: "items",
            fn: function(props) {
              return [
                ...
                _vm._v(" "),
                _c("td", { staticClass: "text-xs-right" }, [
                  _vm._v(_vm._s(props.item.author_id))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-xs-right" }, [
                  _vm._v(_vm._s(props.item.subject_id))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-xs-right" }, [
              ...
              _c(
                ...
                [
                  _c("v-text-field", {
                    ...
                    model: {
                      value: _vm.newTest.name,
                      callback: function($$v) {
                        _vm.$set(_vm.newTest, "name", $$v)
                      },
                      expression: "newTest.name"
                    }
                  }),
                  _vm._v(" "),
                  _c("v-text-field", {
                    ...
                    model: {
                      value: _vm.newTest.questions_count,
                      callback: function($$v) {
                        _vm.$set(_vm.newTest, "questions_count", $$v)
                      },
                      expression: "newTest.questions_count"
                    }
                  }),
                  _vm._v(" "),
                  _c("v-select", {
                    ...
                    model: {
                      value: _vm.newTest.subject_id,
                      callback: function($$v) {
                        _vm.$set(_vm.newTest, "subject_id", $$v)
                      },
                      expression: "newTest.subject_id"
                    }
                  })
                ],
                1
